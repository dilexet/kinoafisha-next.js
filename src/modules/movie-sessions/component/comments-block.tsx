...
export default function CommentsBlock({ comments, currenUserProfileId }: CommentsBlockProps) {
  return (
    <Grid container spacing={4}>
      {
        comments?.map((comment) => (
          <Grid key={comment?.id} item xs={12} style={{
            display: "flex",
            alignItems: "center",
            ...
            <Box style={{
              ...
              <Box style={{
                ...
                borderRadius: "15px",
                padding: "20px",
                backgroundColor: currenUserProfileId === comment?.userProfileId ? "rgb(50, 50, 50)" : "rgb(40, 40, 40)",
              }}>
                <Grid container
                      spacing={1}
                      style={{
