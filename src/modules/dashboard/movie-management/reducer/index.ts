...
const movieManagementSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(movieGetAllActionAsync.pending.type, (state) => {
        state.loadingStatusGetAll = LOADING_STATUSES.LOADING;
        state.errorInfo = null;
      })
      .addCase(
        movieGetAllActionAsync.fulfilled.type,
      ...
      .addCase(
        movieGetAllActionAsync.rejected.type,
      ...
      .addCase(movieGetOneActionAsync.pending.type, (state) => {
        state.loadingStatusGetOne = LOADING_STATUSES.LOADING;
        state.errorInfo = null;
      })
      .addCase(
        movieGetOneActionAsync.fulfilled.type,
        (state, action: PayloadAction<MovieType>) => {
      ...
      .addCase(
        movieGetOneActionAsync.rejected.type,
        (state, action: PayloadAction<any>) => {
      ...
      .addCase(movieUpdateAsync.pending.type, (state) => {
        state.loadingStatusUpdate = LOADING_STATUSES.LOADING;
        state.errorInfo = null;
      })
      .addCase(
        movieUpdateAsync.fulfilled.type,
        (state, action: PayloadAction<MovieType>) => {
          state.loadingStatusUpdate = LOADING_STATUSES.IDLE;
          state.errorInfo = null;
          movieEntityAdapter.updateOne(state, {
      ...
      .addCase(
        movieUpdateAsync.rejected.type,
        (state, action: PayloadAction<any>) => {
      ...
      .addCase(movieCreateAsync.pending.type, (state) => {
        state.loadingStatusCreate = LOADING_STATUSES.LOADING;
        state.errorInfo = null;
      })
      .addCase(
        movieCreateAsync.fulfilled.type,
        (state, action: PayloadAction<MovieType>) => {
      ...
      .addCase(
        movieCreateAsync.rejected.type,
        (state, action: PayloadAction<any>) => {
      ...
      .addCase(movieDeleteAsync.pending.type, (state) => {
        state.loadingStatusDelete = LOADING_STATUSES.LOADING;
        state.errorInfo = null;
      })
      .addCase(
        movieDeleteAsync.fulfilled.type,
      ...
      .addCase(
        movieDeleteAsync.rejected.type,
        (state, action: PayloadAction<any>) => {
      ...
      .addCase(HYDRATE, (state, action: AnyAction) => {
        if (action.payload?.movie_management_reducer?.errorInfo) {
          ...
          state.errorInfo = {
            message:
              action.payload?.movie_management_reducer?.errorInfo?.message,
          ...
          movieEntityAdapter.setAll(
            state,
            action.payload.movie_management_reducer?.entities,
          );
        }
      });
  },
