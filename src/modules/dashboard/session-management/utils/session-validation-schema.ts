...
export const sessionCreateValidationSchema = yup.object({
  hallId: yup.string().required("Please select hall"),
  cinemaId: yup.string().required("Please select cinema"),
  movieId: yup.string().required("Please select movie"),
  sessionTimes: yup.array().of(sessionTimesValidationSchema),
});
...
export const sessionUpdateValidationSchema = yup.object({
  ...
  cinemaId: yup.string().required("Please select cinema"),
  movieId: yup.string().required("Please select movie"),
  sessionTime: yup.object({
    startDate: yup.date().required("Please enter session start date"),
    coefficient: yup
      .number()
...
export type sessionCreateValidationSchemaType =
  typeof sessionCreateValidationSchema;
export type sessionUpdateValidationSchemaType =
  typeof sessionUpdateValidationSchema;
