...
import {
  sessionCreateValidationSchemaType, sessionUpdateValidationSchemaType,
...
export interface SessionFormProps {
  ...
  handleSubmit: (values: SessionCreateFieldsType | SessionUpdateFieldsType) => void;
  handleCancel: () => void;
  sessionState: SessionManagementState;
  validationSchema: sessionCreateValidationSchemaType | sessionUpdateValidationSchemaType;
}